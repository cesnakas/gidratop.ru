...
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/propertys_group.xml";
$iblockCode = "propertys_group_st_".WIZARD_SITE_ID;
$iblockType = "office"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CODE_6" => $iblockID));
?>