...
if(!CModule::IncludeModule("iblock"))
	return;
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/news.xml";
$iblockCode = "content_news_st_".WIZARD_SITE_ID;
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/news/index.php", array("CODE_11" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("CODE_11" => $iblockID));
?>