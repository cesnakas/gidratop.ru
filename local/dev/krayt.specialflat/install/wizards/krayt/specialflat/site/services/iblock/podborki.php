...
if(!CModule::IncludeModule("iblock"))
    return;
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/podborki.xml";
$iblockCode = "catalog_podborki_st_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
$_SESSION["WIZARD_PODBORKI_IBLOCK_ID"] = $iblockID;

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CODE_9" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/header/krayt_new_menu_catalog.php", array("CODE_9" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array("CODE_9" => $iblockID));
?>