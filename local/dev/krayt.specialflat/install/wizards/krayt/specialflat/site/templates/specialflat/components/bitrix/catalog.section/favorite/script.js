$( document ).ready(function() {
    $('.favorite-element-container .elemrnt_box .product-item-container').hover(function(){
    		$(this).addClass('fav_hover');
    		$(this).prev().css('z-index','592');
		},
		function () {
            $(this).removeClass('fav_hover');
            $(this).prev().css('z-index','590');
        }
	);
    ...
    $(document).on('click','.elem-delete',function() {
        var name = 'FOREVER';
        var cookie_zac = $.cookie(name);

        var znach = $(this).attr('data-id')+"|";
