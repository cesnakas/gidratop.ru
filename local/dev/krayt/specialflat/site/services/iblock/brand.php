...
if(!CModule::IncludeModule("iblock"))
    return;
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/brand.xml";
$iblockCode = "catalog_brand_st_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
$_SESSION["WIZARD_BRAND_IBLOCK_ID"] = $iblockID;

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/proizvoditeli/index.php", array("CODE_10" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array("CODE_10" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("CODE_10" => $iblockID));
?>