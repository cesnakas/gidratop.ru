...
if(!CModule::IncludeModule("iblock"))
	return;
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/category.xml";
$iblockCode = "job_category_st_".WIZARD_SITE_ID;
$iblockType = "job";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/category/index.php", array("CODE_1" => $iblockID));
?>