...
if(!CModule::IncludeModule("iblock"))
    return;
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/special_flat_offers.xml";
$iblockXMLFilePrices = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/special_flat_offers_prices.xml";

$iblockCode = "offers_st_".WIZARD_SITE_ID;
$iblockType = "offers";
...
$_SESSION["WIZARD_OFFERS_IBLOCK_ID"] = $iblockID; 

//CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array("OFFERS_IBLOCK_ID" => $iblockID));
//CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.catalog.menu_ext.php", array("OFFERS_IBLOCK_ID" => $iblockID));
