...
<div id="carousel-<?=$arResult['ID']?>" class="banner carousel <?=$arParams['BS_EFFECT']?>" data-interval="<?=$arParams['BS_INTERVAL']?>" data-wrap="<?=$arParams['BS_WRAP']?>" data-pause="<?=$arParams['BS_PAUSE']?>" data-keyboard="<?=$arParams['BS_KEYBOARD']?>" data-ride="carousel">
	<style>
		...
		.carousel-control .icon-prev{margin-top: -14px;}
		.carousel-control .icon-next{margin-top: -14px;}
		.carousel-control.right{background-image:none}
		.carousel-control.left{background-image:none}
	</style>
    <div class="main_slider_container">
    <div class="main_slider_wrp">
	<?if($arParams['BS_BULLET_NAV'] == 'Y' || $arParams['BS_PREVIEW'] == 'Y'):?>
		<ol class="carousel-indicators main_slider_indicators">
		<?$i = 0;?>
	...
	<div class="carousel-inner main_slider" role="listbox">
    ...
    <div class="main_slider_right_part">
