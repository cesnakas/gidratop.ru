...
{
?>
<h3 class="title_box"><?= GetMessage("PROSMOTR"); ?></h3>
<div class="product-carousel-nav-section"></div>
<div class="product-carousel-wrp section_carusel_recomend owl-carousel">
	<?
