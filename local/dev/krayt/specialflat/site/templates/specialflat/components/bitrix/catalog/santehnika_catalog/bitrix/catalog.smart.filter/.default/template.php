                    ...
                    <div class="filter_r_block">
                        <div class="filter_price_block style__filter">
                            <div class="bx-filter-parameters-box-title filter_title">
                                <span><?= GetMessage("FILTER_TITLE")?> </span>
                            ...
                            <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                            {
                                ...
                                if (isset($arItem["PRICE"])):
                                    ...
                                    <div class="opened_list-filter">
                                        ...
                                        else:?>col-lg-12<?endif ?> bx-filter-parameters-box bx-active bx_filter_top">
                                            <span class="bx-filter-container-modef"></span>
                                            <div class="bx-filter-block" data-role="bx_filter_block">
                                                <div class="row bx-filter-parameters-box-container">
                                                    <div class="input__box">
                                                        <div class="bx-ft-title"><?= GetMessage("CT_BCSF_FILTER_TITLE") ?></div>
                                            ...
                                            <div class="bx-filter-block" data-role="bx_filter_block" <?if($open === true){ echo "style='display:block'";}?>>
                                                <div class="bx-filter-parameters-box-container">
                                                    ...
                                                    case "A"://NUMBERS_WITH_SLIDER
                                                        ?>
                                                        <div class="bx-filter-slider_cont">
...
<!--                                        </div>-->
                                ...
                                <div class="title_hide">
                                    <div class="left"><span><?=GetMessage("ROS_POISK");?></span></div>
                                    <div class="right row m_none">
