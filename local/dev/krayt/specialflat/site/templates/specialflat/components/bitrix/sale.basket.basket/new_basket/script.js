$( document ).ready(function() {
	$('.servis input').change(function () {
		var id_tovar = $(this).val();
        ...
        var mas = {'id_tovar' :id_tovar, 'servis' : servis};

        $.post(settingSantech.SITE_TEMPLATE_PATH+'/components/bitrix/sale.basket.basket/new_basket/ajax/logica.php',{
            idmontazh:JSON.stringify(mas)
        },function(data) {

        });
    });

    $('.global_del_basket').click(function () {
