...
<div class="search-page">
    ...
    <form action="" method="get" class="search_page-form">
        <div class="search_input-box">
            ...
            <? if ($arParams["SHOW_WHERE"]): ?>
                <select name="where" class="where_search">
...
<!--                    <a href="" class="per_option active">--><?//= GetMessage("SEARCH_SORTED_BY_DATE") ?><!--</a>-->
<!--                --><?// else: ?>
<!--                    <a href="" class="per_option active">--><?//= GetMessage("SEARCH_SORTED_BY_RANK") ?><!--</a>-->
<!--                    <a class="per_option"-->
...
<!--            </div>-->
<!--        </div>-->
        <div class="search_result-box">
            <? foreach ($arResult["SEARCH"] as $arItem): ?>
                <div class="search_result-item">
                    <div class="search_result-item-box">
                        <a class="search_result-title-link"
                           href="<? echo $arItem["URL"] ?>"><? echo $arItem["TITLE_FORMATED"] ?></a>
                        <div class="search_result-preview">
                            <div class="search_result-text"><? echo $arItem["BODY_FORMATED"] ?></div>
                            <? if (
                            ...
                            <? endif; ?>
                            <div class="search_result-date"><?= GetMessage("SEARCH_MODIFIED") ?> <?= $arItem["DATE_CHANGE"] ?></div>

                            <?
                            if ($arItem["CHAIN_PATH"]):?>
                                <div class="search_result-path"><?= $arItem["CHAIN_PATH"] ?></div><?
                            endif;
                            ?>
                        </div>
                    </div>
