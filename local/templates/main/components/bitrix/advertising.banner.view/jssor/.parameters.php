...
if ($arCurrentValues['EXTENDED_MODE'] == 'N')
{
	$arTemplateParameters["PARAMETERS"]["PRESET"] = Array(
		...
		"TYPE" => "PRESET",
		"IMAGES" => array(
			'1' => '/bitrix/themes/special_flat/icons/advertising/preset1.jpg',
			'2' => '/bitrix/themes/special_flat/icons/advertising/preset2.jpg',
			'3' => '/bitrix/themes/special_flat/icons/advertising/preset3.jpg',
			'4' => '/bitrix/themes/special_flat/icons/advertising/preset4.jpg'
		),
		"DEFAULT" => 1,
		"SORT" => 75
	);
