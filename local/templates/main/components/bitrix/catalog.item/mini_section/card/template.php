...
<div class="product-item">
    <div class="product-item-box">
        <a class="product-item-image-wrapper" data-entity="image-wrapper" href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>">
            ...
            <div class="item_lable_blck">
                ...
                <? foreach ($item['LABEL_ARRAY_VALUE'] as $code => $value) { ?>
                    ...
                    if(!isset($item['LABEL_PROP_MOBILE'][$code])){echo "";} ?>
                     ">
                        ...
                        <div class="product-item-compare">
                            <div class="checkbox open_hint" id="<?= $itemIds['COMPARE_LINK'] ?>">
                                ...
                                <label for="<?= $itemIds['COMPARE_LINK'] ?>">
                                    <div class="hint" data-label
                                    <span class="bar-chart"><i></i><i></i><i></i></span>in="<?= GetMessage("IN_SRAVNENIE"); ?>" data-label-out="<?= GetMessage("OUT_SRAVNENIE"); ?>"></div>
                                </label>
                            </div>
                        </div>
                    </div>
