...
<div class="smart-filter mb-4 <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal"?>">
	<div class="smart-filter-section">
		...
		<div class="gt-show-mobile gt-catalog-filter-mobile-title">
            <span id="gtMobileFilterPanelName"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></span>
        </div>
			...
			<div class="__row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-12<?endif?> mb-2 smart-filter-parameters-box bx-active gt-aside-block expanded">
							<span class="smart-filter-container-modef"></span>

							<div class="smart-filter-parameters-box-title gt-aside-block-title" onclick="smartFilter.hideFilterProps(this)">
                                <!--<span data-role="prop_angle" class="smart-filter-angle smart-filter-angle-up">
									<span class="smart-filter-angles"></span>
								</span>-->
								<a class="smart-filter-parameters-box-title-text gt-aside-toggler" onclick="clickCatalogExpand(event, this)">
                                    <?=$arItem["NAME"]?>
                                </a>

							</div>

							<div class="smart-filter-block gt-aside-block-content" data-role="bx_filter_block">
								<div class="smart-filter-parameters-box-container ">
									<div class="smart-filter-input-group-number gt-rangebox">
										<div class="d-flex justify-content-between inputs">
											<div class="form-group" style="width: calc(50% - 10px);">
												<div class="smart-filter-input-container gt-inputbox">
													<input
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="gt-aside-block expanded <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> mb-2 smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="smart-filter-container-modef"></span>
