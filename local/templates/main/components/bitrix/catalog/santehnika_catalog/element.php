...
$elementId = $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'DOP_ELEMENT_PROPERTY_ONE' => $arParams['DOP_ELEMENT_PROPERTY_ONE'],
        'DOP_ELEMENT_PROPERTY_TWO' => $arParams['DOP_ELEMENT_PROPERTY_TWO'],
        'DOP_ELEMENT_PROPERTY_THREE' => $arParams['DOP_ELEMENT_PROPERTY_THREE'],
        'DOP_SKU_PROPERTY_ONE' => $arParams['DOP_SKU_PROPERTY_ONE'],
        'DOP_SKU_PROPERTY_TWO' => $arParams['DOP_SKU_PROPERTY_TWO'],
        'DOP_SKU_PROPERTY_THREE' => $arParams['DOP_SKU_PROPERTY_THREE'],
        "I_BLOCK_GROUP_PROP" => $arParams['I_BLOCK_GROUP_PROP'],
        "PROPERTY_TOP_ONE" => $arParams['PROPERTY_TOP_ONE'],
        "PROPERTY_TOP_TWO" => $arParams['PROPERTY_TOP_TWO'],
        "PROPERTY_TOP_THREE" => $arParams['PROPERTY_TOP_THREE'],
        "PROPERTY_TOP_FOUR" => $arParams['PROPERTY_TOP_FOUR'],
        "PROPERTY_TOP_FIVE" =>$arParams['PROPERTY_TOP_FIVE'],
        'PROP_1' => $arParams['PROP_1'],
        'PROP_2' => $arParams['PROP_2'],
        'PROP_3' => $arParams['PROP_3'],
        'PROP_4' => $arParams['PROP_4'],
        'PROP_5' => $arParams['PROP_5'],
        'PROP_DOP_1' => $arParams['PROP_DOP_1'],
        'PROP_DOP_2' => $arParams['PROP_DOP_2'],
        'PROP_DOP_3' => $arParams['PROP_DOP_3'],
        "PROP_ARTICUL" => $arParams["PROP_ARTICUL"],
        'PROP_DOP_1_IMG' => $arParams['PROP_DOP_1_IMG'],
        'PROP_DOP_2_IMG' => $arParams['PROP_DOP_2_IMG'],
        'PROP_DOP_3_IMG' => $arParams['PROP_DOP_3_IMG'],
...
<div class="recom_of">
 ...
 $GLOBALS['myFilter'] = array('ID' => $arParamsElm[$elementId]['PROPERTIES']['COMFORT_DOP']["VALUE"]);
//$arFilterBigDataElement = array('!PROPERTY_NO_CATALOG'=>"Y");

//  global $arFilterBigDataElement;
//print_r($GLOBALS['myFilter'] );
        ?>
        ...
        <?$APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "OFFER_ADD_PICT_PROP" => $arParams['OFFERS_PROPERTY_CODE'],
