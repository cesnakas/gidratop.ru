...
<div class="gt-section-title">
    <h2>Статьи</h2>
    <div class="bg-text">Aricles</div>
</div>



<div class="gt-news-list gt-grid-news-list">
    <? $i = 1; ?>
    <? foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            ?>
            <div class="item gt-news-item full-mobile">
...
<section class="news_in_glav-22" style="display:none;">
    <div class="title_box">
