							...
							<div class="row">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="sale-order-detail-about-order-inner-container-repeat-button btn_anim">
										...
										{
											?>
											<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="sale-order-detail-about-order-inner-container-repeat-cancel btn_anim">
												...
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="col-md-2 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
															...
															{
																?>
																<a class="btn-theme sale-order-detail-payment-options-methods-button-element-new-window btn_anim"
																   target="_blank"
