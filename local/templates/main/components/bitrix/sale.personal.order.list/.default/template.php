			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-container">
						...
						<div class="row sale-order-list-inner-row">
							<div class="sale-order-list-top-border"></div>
							<div class="col-md-8  col-sm-6 col-xs-4 sale-order-list-about-container">
								<a class="sale-order-list-about-link btn_anim" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
                                   <span> <?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span>
                                </a>
							</div>
							<div class="col-md-2 col-sm-3 col-xs-4 sale-order-list-repeat-container">
								<a class="sale-order-list-repeat-link btn_anim" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
                                    <span><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></span>
                                </a>
							</div>
							<div class="col-md-2 col-sm-3 col-xs-4 sale-order-list-cancel-container">
								<a class="sale-order-list-cancel-link btn_anim" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>">
					...
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							...
							<div class="col-md-3 col-md-offset-6 col-xs-6 sale-order-list-repeat-accomplished">
								<a class="sale-order-list-repeat-link sale-order-link-accomplished btn_anim" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
									<span><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></span>
								</a>
							</div>
						</div>
