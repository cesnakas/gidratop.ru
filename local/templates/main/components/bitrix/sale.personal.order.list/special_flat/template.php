...
<h1><?=GetMessage("MAIN_ZAKAZ_TITLE");?></h1>
<?
...
else
{
	...
	?>
	<div class="history_link_block row col-md-12 col-sm-12">
		<?
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-container">
									...
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
									{
										if ($order['ORDER']['IS_ALLOW_PAY'] == 'N')
										{
											...
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button inactive-button btn">
										...
										elseif ($payment['NEW_WINDOW'] === 'Y')
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button btn" target="_blank" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
										...
										else
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button ajax_reload btn" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
						...
						<div class="row sale-order-list-inner-row">
							<div class="sale-order-list-top-border"></div>
							<div class="col-md-8  col-sm-6 col-xs-12 sale-order-list-about-container">
								<a class="sale-order-list-about-link btn " href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
                                   <span> <?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span>
                                </a>
							</div>
							<div class="col-md-2 col-sm-3 col-xs-12 sale-order-list-repeat-container">
								<a class="sale-order-list-repeat-link btn" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
                                    <span><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></span>
                                </a>
							</div>
							<div class="col-md-2 col-sm-3 col-xs-12 sale-order-list-cancel-container">
								<a class="sale-order-list-cancel-link btn" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>">
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							<div class="col-md-3 col-xs-6 sale-order-list-about-accomplished">
								<a class="sale-order-list-about-link btn" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
									<span><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span>
								</a>
							</div>
							<div class="col-md-3 col-md-offset-6 col-xs-6 sale-order-list-repeat-accomplished">
								<a class="sale-order-list-repeat-link sale-order-link-accomplished btn" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
									<span><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></span>
								</a>
							</div>
						</div>
