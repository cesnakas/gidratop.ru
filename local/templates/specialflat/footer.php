...
?>
                    ...
                    <div class="c-footer">
                        <div class="footer-left">
                            ...
                            <div class="footer-right-block pay">
                                <div class="title">
                                    <?php $APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/footer_pay_title.php")); ?>
                                </div>
                                <div class="cards">
                                    <?php $APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/footer_pay.php")); ?>
                                </div>
                            </div>
                        </div>
	...
	false
                            ...
                            <div class="footer-right-block contacts">
                                <div class="title_box">
                                    <?=Loc::getMessage('K_KONTACT_TITLE')?>
                                </div>
                                <div>
                ...
                <div class="footer_bottom">
                    <div class="w1200">
                        <div class="left">
                            <?=Loc::getMessage('K_COPY_DEV_SITE')?>
                                <a href="https://krayt.ru" target="_blank">
                                    <?=Loc::getMessage('K_COPY_WEB_STUDIO')?> <span><?=Loc::getMessage('K_COPY_WEB_STUDIO_KRAYT')?></span></a>
                        </div>
                        <div class="right">
                            <?=Loc::getMessage('K_COPY_ROOM')?>
                        </div>
                    </div>
                </div>
            </footer>
            ...
            <div class="left_panel">
                <div class="head">
                    <a class="footer-logo" href="<?= SITE_DIR ?>">
                        <?php $APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/logo_menu.php")); ?>
                    </a>
                    <i class="close-btn"></i>
                </div>
                <div class="content">
                ...
                <script>
                    BX.ready(function() {
                        ...
                        BX.bind(BX('cookies_modal_btn'), 'click', function() {
                            BX.setCookie('show_cookies_modal', "1", {
                                path: "/"
                            });
                            BX.adjust(BX('cookies_modal'), {
                                style: {
